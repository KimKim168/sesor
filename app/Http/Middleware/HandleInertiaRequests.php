...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'media_links' => Link::whereIn('type_code', ['social-media'])->orderBy('order_index', 'desc')->get(),
            'contact_detail' => Link::whereIn('type_code', ['contact'])->orderBy('order_index', 'desc')->get(),
