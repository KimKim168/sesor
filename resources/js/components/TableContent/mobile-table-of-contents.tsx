...
export function MobileTableOfContents() {
    return (
        <Drawer>
            <DrawerTrigger className="fixed right-6 bottom-6 z-50 rounded-full bg-primary p-3 text-primary-foreground shadow-lg transition-colors hover:bg-primary/90 lg:hidden">
                <List size={20} />
            </DrawerTrigger>
