...
export function NavbarLogo2() {
    ...
    const logo = website_info?.logo
        ? `/assets/images/website_infos/thumb/${website_info.logo}`
        : '/assets/images/default-logo.png';

    const logoDark = website_info?.logo_darkmode
        ? `/assets/images/website_infos/thumb/${website_info.logo_darkmode}`
        : logo;
        ...
        <Link href={`/`}>
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                    ...
                    {website_info?.name && (
                        <p className="text-xl leading-tight font-semibold text-muted-foreground md:text-2xl">
                            {website_info?.name}
                        </p>
                    )}
                    {/* {description && (
