...
import { FilterButtonCollection } from '../Components/Button/FilterButtonCollection';
import PaginationTabs from '../Components/Pagination/PaginationTabs';
import SearchDetial from '../Components/Search/SearchDetail';
import ResourceSidebarCollection from '../Components/Sidebar/ResourceSidebarCollection';
    ...
    return (
        <BookCamboLayout>
            ...
            <div className="mx-auto mt-6 flex max-w-screen-2xl px-4 sm:px-10 md:gap-8 xl:px-20">
                <div className="md:w-64 hidden xl:block">
                    <ResourceSidebarCollection />
                </div>
                <div className="w-full md:flex-1">
                    <div className="mb-4 flex items-center justify-between border-b-4 border-[#104674] pb-2">
                        <div className="text-xl font-bold text-gray-900 dark:text-white sm:text-xl lg:text-xl">All books</div>
