...
const Contact = () => {
    const { media_links, website_info, app_url, contact_detail } = usePage<any>().props;
    return (
                ...
                <div className="mt-2.5 grid gap-5 md:mt-5 md:gap-10 lg:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-manrope-semi-bold text-[17px] text-[#231F20] md:text-xl">Call Us</h3>
                                <p
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-manrope-semi-bold text-[17px] text-[#231F20] md:text-xl">Email Us</h3>
                                <p
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-manrope-semi-bold text-[17px] text-[#231F20] md:text-xl">Website</h3>
                                <p
                                    className="font-manrope-regular text-[12px] text-[#231F20] md:text-[15px]"
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-manrope-semi-bold text-[17px] text-[#231F20] md:text-xl">Address</h3>
                                <p
                                    className="font-manrope-regular text-[12px] text-[#231F20] md:text-[15px]"
                                    dangerouslySetInnerHTML={{
                                        __html: website_info?.address,
                                    }}
                                />
                            </div>
                        </div>
